...
ECHO.
REM ECHO The Stock Quote example is available in three variations:
ECHO The Stock Quote example is available in two variations:
ECHO   1. REST
ECHO   2. SOAP
REM ECHO   3. WSDL
...
REM IF '%Choice%'=='3' call %MULE_BASE%\bin\mule.bat -config .\conf\wsdl-config.xml
