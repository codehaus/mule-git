...
/**
 * This is the item provider adapter for a {@link org.mule.ide.prototype.mulemodel.Properties} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertiesItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MulePackage.Literals.PROPERTIES__PROPERTIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Properties")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return getString("_UI_Properties_type"); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Properties.class)) {
			case MulePackage.PROPERTIES__PROPERTIES:
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MulePackage.Literals.PROPERTIES__PROPERTIES,
