...
public class FatalConnectException extends FatalException
{
    ...
    public FatalConnectException(Message message, RetryTemplate component)
    {
        super(message, component);
    }

    public FatalConnectException(Message message, Throwable cause, RetryTemplate component)
    {
        super(message, cause, component);
    }

    public FatalConnectException(Throwable cause, RetryTemplate component)
    {
