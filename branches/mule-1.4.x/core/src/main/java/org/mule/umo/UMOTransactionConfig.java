...
public interface UMOTransactionConfig
{
    ...
    /**
     * There is a need to separate ACTION_NONE with TransactionFactory and
     * not initialized transaction config (factory was not sed)
     *
     * @return true if transaction factory is set
     */
