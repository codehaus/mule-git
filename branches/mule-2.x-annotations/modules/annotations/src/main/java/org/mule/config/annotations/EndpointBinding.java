 ...
 * on the interface is called the endpoint will be invoked
 */
...
public @interface EndpointBinding
{
    ...
    /**
     * The method to called on the bound interface. This argument can be ommitted if there is
     * only one method on the bound interface
     * @return the method name to call or an empty string if it has not been set
     */
    String interfaceMethod() default "";
}
