...
public class TransformerCachingTestCase extends AbstractMuleTestCase
{
    ...
    {
        SimpleDataType<FilterInputStream> streamDataType = new SimpleDataType<FilterInputStream>(FilterInputStream.class);
        Transformer trans = muleContext.getRegistry().lookupTransformer(streamDataType, DataTypeFactory.BYTE_ARRAY);
        assertNotNull(trans);
        ...
        trans = muleContext.getRegistry().lookupTransformer(streamDataType, DataTypeFactory.BYTE_ARRAY);
        assertNotNull(trans);
