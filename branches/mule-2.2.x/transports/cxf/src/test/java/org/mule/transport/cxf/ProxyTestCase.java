...
public class ProxyTestCase extends FunctionalTestCase
{
    ...
    // MuleMessage result = client.send("http://localhost:63081/services/Echo", msg,
    // null);
    // String resString = result.getPayloadAsString();
    // assertTrue(resString.indexOf("<test xmlns=\"http://foo\"> foo </test>") !=
    // -1);
    // }
    //    
    ...
    // + "<soap:Body> <test xmlns=\"http://foo\"></test>" + "</soap:Body>" +
    // "</soap:Envelope>";
    //
    // MuleClient client = new MuleClient();
    // MuleMessage result = client.send("http://localhost:63081/services/proxy", msg,
    // null);
    // String resString = result.getPayloadAsString();
    ...
    // for (int i = 0; i < 20; i++) {
    // MuleMessage result =
    // client.send("http://localhost:63081/services/envelope-proxy", msg, null);
    //
    // String resString = result.getPayloadAsString();
    // assertTrue(resString.indexOf("<test xmlns=\"http://foo\"") != -1);
    // }
    ...
    // getComponent("serverClientProxyWithWsdl")).setEventCallback(new
    // EventCallback()
    // {
    //
    // public void eventReceived(MuleEventContext context, Object component) throws
    // Exception
    // {
    // latch.countDown();
    // }
    ...
    // MuleClient client = new MuleClient();
    // MuleMessage result =
    // client.send("http://localhost:63081/services/proxyWithWsdl", msg, null);
    // String resString = result.getPayloadAsString();
    ...
    // final Latch latch = new Latch();
    // ((FunctionalTestComponent)
    // getComponent("serverClientProxyWithWsdl2")).setEventCallback(new
    // EventCallback()
    // {
    //
    // public void eventReceived(MuleEventContext context, Object component) throws
    ...
    // MuleClient client = new MuleClient();
    // MuleMessage result =
    // client.send("http://localhost:63081/services/proxyWithWsdl2", msg, null);
    // String resString = result.getPayloadAsString();
    // assertTrue(latch.await(1000, TimeUnit.MILLISECONDS));
    // assertTrue(resString.indexOf("<test xmlns=\"http://foo\"") != -1);
    // }
    ...
    // MuleClient client = new MuleClient();
    // MuleMessage result =
    // client.send("http://localhost:63081/services/proxyWithTransform", msg, null);
    // String resString = result.getPayloadAsString();
    // System.out.println(resString);
    ...
    // MuleClient client = new MuleClient();
    // MuleMessage result =
    // client.send("http://localhost:63081/services/greeter-databinding-proxy", msg,
    // null);
    // String resString = result.getPayloadAsString();
    ...
    // MuleClient client = new MuleClient();
    // MuleMessage result =
    // client.send("http://localhost:63081/services/transform-proxy", msg, null);
    // String resString = result.getPayloadAsString();
    // assertTrue(resString.indexOf("greetMeResponse") != -1);
    // }
    //
    ...
    // MuleClient client = new MuleClient();
    // MuleMessage result =
    // client.send("http://localhost:63081/services/routeBasedOnSoapAction", msg,
    // props);
    // String resString = result.getPayloadAsString();
    // System.out.println(resString);
    // assertTrue(resString.indexOf("<transformed xmlns=\"http://foo\">") != -1);
