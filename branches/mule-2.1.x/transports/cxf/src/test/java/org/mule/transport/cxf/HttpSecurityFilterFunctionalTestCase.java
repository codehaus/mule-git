...
public class HttpSecurityFilterFunctionalTestCase extends FunctionalTestCase
{
    ...
    public void testAuthenticationFailureNoContextPost() throws Exception
    {
        ...
        StringRequestEntity requestEntity = new StringRequestEntity("testPaylod", "text/plain", "UTF-8");
    ...
    {
        doGet(null, "localhost", "anonX", "anonX", "http://localhost:60443/services/Echo", true, true, 401);
    }
    ...
    {
        doGet(null, "localhost", "anon", "anon", "http://localhost:60443/services/Echo", false, true, 200);
    }

    public void testAuthenticationAuthorisedGetHttps() throws Exception
    {
        doGet(null, "localhost", "anon", "anon", "https://localhost:60444/services/Echo", false, true, 200);
    }
    ...
    {
        doGet(null, "localhost", "anon", "anon", "http://localhost:60443/services/Echo", true, false, 200);
    }
    ...
    {
        doGet("blah", "localhost", "anon", "anon", "http://localhost:60443/services/Echo", true, false, 401);
    }
    ...
    {
        doGet("mule-realm", "localhost", "ross", "ross", "http://localhost:60443/services/Echo", true, false,
            200);
    }
