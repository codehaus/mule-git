...
public class ConnectorLifecycleTestCase extends AbstractMuleTestCase
{
    ...
    /**
     * This test ensures that the connector is only initialised once even on a direct
     * initialisation (not through Mule).
     */
    ...
    /**
     * This test ensures that the connector is only started once even on a direct
     * restart (not through Mule).
     */
    ...
    /**
     * This test ensures that the connector is only stopped once even on a direct
     * restop (not through Mule).
     */
    ...
    /**
     * This test ensures that the connector is only disposed once even on a direct
     * disposal (not through Mule).
     */
