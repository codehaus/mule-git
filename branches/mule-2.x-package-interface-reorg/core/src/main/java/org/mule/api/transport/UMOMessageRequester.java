...
/**
 * Combine {@link org.mule.api.transport.UMOMessageRequesting} with
...
public interface UMOMessageRequester extends Disposable, UMOConnectable, UMOMessageRequesting
{
     ...
     * {@link org.mule.api.transport.UMOMessageDispatching} methods are invoked.
     *
     * @see {@link org.mule.api.transport.UMOMessageDispatcherFactory#activate(org.mule.api.endpoint.UMOImmutableEndpoint, org.mule.api.transport.UMOMessageDispatcher)}
     */
    void activate();
     ...
     *
     * @see {@link org.mule.api.transport.UMOMessageDispatcherFactory#passivate(org.mule.api.endpoint.UMOImmutableEndpoint, org.mule.api.transport.UMOMessageDispatcher)}
     */
    void passivate();
