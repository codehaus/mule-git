...
/**
 * Combine {@link UMOMessageDispatching} with
...
public interface UMOMessageDispatcher extends Disposable, UMOConnectable, UMOMessageDispatching
{
     ...
     * 
     * @see {@link UMOMessageDispatcherFactory#activate(org.mule.api.endpoint.UMOImmutableEndpoint, UMOMessageDispatcher)}
     */
    void activate();
     ...
     * 
     * @see {@link UMOMessageDispatcherFactory#passivate(org.mule.api.endpoint.UMOImmutableEndpoint, UMOMessageDispatcher)}
     */
    void passivate();
