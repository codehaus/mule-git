 ...
 * {@link org.mule.api.endpoint.UMOImmutableEndpoint} as the key and the requester as pooled object.
 */
public interface UMOMessageRequesterFactory
{
     ...
     * {@link #validate(org.mule.api.endpoint.UMOImmutableEndpoint, org.mule.api.transport.UMOMessageRequester)} it takes
     * precedence over the dispatcher's own return value of
     * {@link org.mule.api.transport.UMOMessageDispatcher#validate()}.
     *
     ...
     *         transport
     * @throws org.mule.api.UMOException if the requester cannot be created
     */
     ...
     * client, but <strong>not</strong> after {@link #create(org.mule.api.endpoint.UMOImmutableEndpoint)}.
     *
     * @param endpoint the endpoint of the requester
     * @param requester the requester to be activated
     * @throws org.mule.api.UMOException if the requester cannot be activated
     */
     ...
     * {@link #passivate(org.mule.api.endpoint.UMOImmutableEndpoint, org.mule.api.transport.UMOMessageRequester)}.
     *
     * @param endpoint the endpoint of the requester
     ...
     * {@link #validate(org.mule.api.endpoint.UMOImmutableEndpoint, org.mule.api.transport.UMOMessageRequester)}.
     *
     * @param endpoint the endpoint of the requester
     * @param requester the requester to be validated
     */
