...
/**
 * <code>AbstractMuleException</code> is the base exception type for the Mule server any
 * other exceptions thrown by Mule code will be based on this exception,
 */
public abstract class AbstractMuleException extends Exception
{
     ...
     */
    public AbstractMuleException(Message message)
    {
        super();
        setMessage(message);
    }
     ...
     */
    public AbstractMuleException(Message message, Throwable cause)
    {
    ...
    public AbstractMuleException(Throwable cause)
    {
        super((cause instanceof InvocationTargetException
                        ? ((InvocationTargetException) cause).getTargetException() : cause));
        if (cause != null)
    ...
    protected AbstractMuleException()
    {
        super();
        initialise();
    }
    ...
    {
        AbstractMuleException e = ExceptionHelper.getRootMuleException(this);
        if (!e.equals(this))
        {
            return getMessage();
        }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof AbstractMuleException))
        {
            return false;
        }

        final AbstractMuleException umoException = (AbstractMuleException) o;
