...
public class GroovyRefreshableBeanTestCase extends AbstractRefreshableBeanTestCase
{
    ...
    public static final String ON_CALL_RECEIVED = "import org.mule.api.EventContext; import org.mule.api.lifecycle.Callable; public class GroovyDynamicScript implements Callable { public Object onCall(EventContext eventContext) throws Exception{ return eventContext.getMessage().getPayloadAsString() + \"" + RECEIVED + "\"; }}";
