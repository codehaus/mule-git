...
public class AggregatorIntegrationTimeoutFailTestCase extends FunctionalTestCase
{
    private CountDownLatch latch;

    protected String getConfigResources()
    {
        return "org/mule/test/integration/routing/test-correlation-aggregator-timeout-fail.xml";
    }
