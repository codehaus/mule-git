...
public class AggregatorIntegrationNoTimeoutTestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        return "org/mule/test/integration/routing/test-correlation-aggregator-no-timeout.xml";
    }
