...
//        registerBeanDefinitionParser("model-pipeline", new OrphanDefinitionParser(PipelineModel.class, true));
        ...
        registerBeanDefinitionParser("rest-service-component",
            new SimpleSingleParentFamilyDefinitionParser(new SimplePojoServiceDefinitionParser(RestServiceWrapper.class))
        ...
        //Inbound Routers
        registerBeanDefinitionParser("forwarding-router", new RouterDefinitionParser("router", ForwardingConsumer.class));
