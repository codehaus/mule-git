...
public class TcpRemoteSynchTestCase extends FunctionalTestCase
{
	...
	public void test_Tcp_Tcp_RemoteSynch() throws Exception
	{
    ...
    public void test_Tcp_Vm_RemoteSynch() throws Exception
    {
        MuleClient client = new MuleClient();
        Map props = new HashMap();
