...
public class FooMessageDispatcher extends AbstractMessageDispatcher
{
     ...
     */
    public void doConnect(UMOImmutableEndpoint endpoint) throws Exception
    {
    ...
    {
    	//Todo return the delegate session object for this transport if any.  This can be left null
        return null;
    }
