...
{
    public ObjectPool createPool(UMODescriptor descriptor, UMOModel model, ObjectFactory factory)
    {
        return new CommonsPoolProxyPool((MuleDescriptor)descriptor, model, factory);
    }

    public ObjectPool createPool(UMODescriptor descriptor, UMOModel model)
    {
        return new CommonsPoolProxyPool((MuleDescriptor)descriptor, model, new CommonsPoolProxyFactory(
            (MuleDescriptor)descriptor, model));
    }
}
