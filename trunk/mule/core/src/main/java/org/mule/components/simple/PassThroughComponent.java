 ...
 * result.
 *
 * @deprecated The {@link BridgeComponent} should be used since is removes the the slight overhead of invoking the service object
 * by never acutally causig an invocation
 */
