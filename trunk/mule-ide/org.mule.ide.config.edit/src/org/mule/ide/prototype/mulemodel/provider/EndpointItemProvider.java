...
/**
 * This is the item provider adapter for a {@link org.mule.ide.prototype.mulemodel.Endpoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndpointItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Endpoint_address_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Endpoint_address_feature", "_UI_Endpoint_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 MulePackage.Literals.ENDPOINT__ADDRESS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Endpoint)object).getAddress();
