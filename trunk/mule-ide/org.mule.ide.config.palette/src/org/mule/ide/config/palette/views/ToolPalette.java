...
import org.mule.ide.config.palette.PaletteItem;
import org.mule.ide.config.palette.PaletteRegistryReader;
...
public class ToolPalette extends ViewPart {
	...
	class ViewContentProvider implements IStructuredContentProvider, 
		...
		private FolderItem invisibleRoot;
		...
		public Object getParent(Object child) {
			if (child instanceof PaletteItem) {
				return ((PaletteItem)child).getParent();
			}
			return null;
		}
		public Object [] getChildren(Object parent) {
			if (parent instanceof FolderItem) {
				return ((FolderItem)parent).getChildren();
			}
			return new Object[0];
		}
		public boolean hasChildren(Object parent) {
			if (parent instanceof FolderItem)
				return ((FolderItem)parent).hasChildren();
			return false;
		}
/*
 ...
 */
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				ToolPalette.this.fillContextMenu(manager);
			}
		});
	...
	/**
	 * Configuring the drag actions
	 */
	public void setupDragActions() {
		viewer.addDragSupport(DND.DROP_COPY|DND.DROP_MOVE,
				new Transfer[] {LocalSelectionTransfer.getTransfer() },
				new ViewDragListener(viewer));
	}
