 ...
 * <ul>
 *   <li>{@link org.mule.ide.prototype.mulemodel.impl.PropertyImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PropertyImpl extends EObjectImpl implements Property {
	...
	protected EClass eStaticClass() {
		return MulePackage.Literals.PROPERTY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MulePackage.PROPERTY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MulePackage.PROPERTY__NAME:
				return getName();
		}
