...
/**
 * This is the item provider adapter for a {@link org.mule.ide.prototype.mulemodel.ComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentType_name_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_name_feature", "_UI_ComponentType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 MulePackage.Literals.COMPONENT_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MulePackage.Literals.COMPONENT_TYPE__OUTBOUND_ROUTER);
			childrenFeatures.add(MulePackage.Literals.COMPONENT_TYPE__INTERCEPTORS);
			childrenFeatures.add(MulePackage.Literals.COMPONENT_TYPE__INBOUND_ROUTER);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ComponentType_type") : //$NON-NLS-1$
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MulePackage.Literals.COMPONENT_TYPE__OUTBOUND_ROUTER,
				 MuleFactory.eINSTANCE.createOutboundRouterType()));

		newChildDescriptors.add
			(createChildParameter
				(MulePackage.Literals.COMPONENT_TYPE__INTERCEPTORS,
				 MuleFactory.eINSTANCE.createInterceptor()));

		newChildDescriptors.add
			(createChildParameter
				(MulePackage.Literals.COMPONENT_TYPE__INBOUND_ROUTER,
				 MuleFactory.eINSTANCE.createInboundRouterType()));
	}
