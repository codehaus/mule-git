...
/**
 * This is the item provider adapter for a {@link org.mule.ide.prototype.mulemodel.Router} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RouterItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MulePackage.Literals.ROUTER__LOCAL_ENDPOINTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Router")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return getString("_UI_Router_type"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MulePackage.Literals.ROUTER__LOCAL_ENDPOINTS,
				 MuleFactory.eINSTANCE.createLocalEndpoint()));
	}
