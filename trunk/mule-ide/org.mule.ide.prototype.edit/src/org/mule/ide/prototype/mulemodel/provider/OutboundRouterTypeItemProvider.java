...
/**
 * This is the item provider adapter for a {@link org.mule.ide.prototype.mulemodel.OutboundRouterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutboundRouterTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutboundRouterType_outboundEndpoint_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_OutboundRouterType_outboundEndpoint_feature", "_UI_OutboundRouterType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 MulePackage.Literals.OUTBOUND_ROUTER_TYPE__OUTBOUND_ENDPOINT,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OutboundRouterType")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return getString("_UI_OutboundRouterType_type"); //$NON-NLS-1$
	}
